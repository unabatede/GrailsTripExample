            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="airline.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: airlineInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="airline.name.label" default="Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: airlineInstance, field: "name")}</td>
